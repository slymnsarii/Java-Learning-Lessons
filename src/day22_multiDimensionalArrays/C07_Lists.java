...
public class C07_Lists {
    public static void main(String[] args) {
        ...
        /*
        List primitive data turlerini kabul etmez, o yuzden Wrapper Class yaparız(izle tekrar28.dk)
        ...
        sayilar.add(2,10); //index'i 2 olan yere 10 elementini ekleyelim(once index sonra eklenecek element)
