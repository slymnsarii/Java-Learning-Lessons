...
public class C03_Exceptions {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Yazdiginiz deger sadece rakamlarda olusmalidir");
        }
        catch (Exception e) {
        ...
        /*
        Kullanicidan String olarak bir deger aliyor ve bunu int'a ceviriyorsak
        NumberFormatException ile karsilabilecegimizi ongoruruz
