...
import java.util.List;
    ...
    public static void main(String[] args) {
        ...
        //illa da 5'i silsin istiyorsam(once 5'in index'ini bulurum, sonra da o index'i silmesi icin remove kullanirim
        // yada yeni bir degisken tanimlarim)

        //illa 5'i silsin dersek
        //silincek objeyi bir variable'a tanimlayabiliriz
        Integer sil=5;
