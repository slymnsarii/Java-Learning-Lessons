...
public class C09_ArraydenListYapmak {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("arrayde degisiklik yapinca(list'de degil) sayilar2 : "+sayilar2);
        //arrayde degisiklik yapinca(list'de degil) sayilar2 : [20, 3, 5, 6, 8, 4, 2, 6, 9, 0, 1, 3, 6, 4, 2, 7, 0]
    }
}
