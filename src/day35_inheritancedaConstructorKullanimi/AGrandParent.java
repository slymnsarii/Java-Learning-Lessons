...
public class AGrandParent {
    ...
    /*
    Her class'da gorulmese bile bir constructor vardir
    ...
    AGrandParent(){
        System.out.println("Grandpa constructor calisti");//parametresiz constructor'in calistigini gormek icin olusturduk
    }
