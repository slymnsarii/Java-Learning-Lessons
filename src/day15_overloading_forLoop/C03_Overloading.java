...
public class C03_Overloading {
    public static void main(String[] args) {
        topla(5,7); //12
        topla(5.2,3); //double-int method'u calisir, hangi mehod'un calisacagina hem data turune hem siralanisa bakiyor //8.2
        topla(3.4,6.1); //9.
    ...
    public static void topla(int sayi1, int sayi2){ //return type'i void
